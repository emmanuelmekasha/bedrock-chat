  ...
  translation: {
    ...
    model: {
      ...
      'claude-v4.7-opus': {
        ...
        description:
          'Wysoko wydajny model Opus stworzony do programowania, przepływów pracy w przedsiębiorstwach i długotrwałych zadań agentowych.',
      },
      'claude-v4.8-opus': {
        label: 'Claude 4.8 (Opus)',
        description:
          'Najnowszy model Opus z ulepszonymi możliwościami rozumowania, programowania i agenta w rozszerzonych oknach kontekstu.',
      },
      'claude-v3-opus': {
        label: 'Claude 3 (Opus)',
